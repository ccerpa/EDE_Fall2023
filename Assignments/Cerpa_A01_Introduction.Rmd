...
> Answer: I worked as a data and GIS specialist for a Southern U.S. social justice non-profit organization. I mainly used Excel and Tableau for my analyses, but used R to analyze Racially Polarized Voting patterns (regressive analyses). I also took a Python course last fall at UNC.

2. Are there any components of the course about which you feel confident?

> Answer: I feel comfortable with many of the terms, thanks to that Python course. I also feel confident in my ability to workshop problems, using online resources like Stack Overflow and the R for Data Science book.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I am not as confident in my theoretical knowledge of statistics, though that is a learning curve.
...
> Answer: https://github.com/ccerpa/EDE_Fall2023
